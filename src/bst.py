...
class Node(object):
    ...
    def __init__(self, data=None, value=None, left=None, right=None):
        """The Node initializer with a data, value, left and right child."""
        self.data = data
        self.value = value
        self.left = left
        self.right = right
...
class BST(object):
    ...
    def insert(self, val, data):
        ...
        new_node = Node(value=val, data=data)
    ...
    def balance(self):
        """
            Return the difference in _size in depth of the left and right
